...
public class Personal_t extends Persona{
    ...
    public Personal_t(int fk_persona, String contrasena, int fk_tipo_personal, boolean persona_activa, int id, int id_persona, String tipo_Id, String nom1_persona, String nom2_persona, String ape1_persona, String ape2_persona, Date fecha_nacimiento, String direc_persona, long tel_persona, String email_persona, int fk_genero, int fk_eps, int fk_rh, Genero genero, Eps eps, Rh rh) {

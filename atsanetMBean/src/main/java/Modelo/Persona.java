...
public class Persona {
    ...
    public Persona(int id, int id_persona, String tipo_Id, String nom1_persona, String nom2_persona, String ape1_persona,
            String ape2_persona, Date fecha_nacimiento, int edad_persona, String direc_persona, long tel_persona,
            String email_persona, int fk_genero, int fk_eps, int fk_rh) {
        this.id = id;
    ...
    public String toString() {
        return "Persona{" + "id=" + id + ", id_persona=" + id_persona + ", tipo_Id=" + tipo_Id + ", nom1_persona="
                + nom1_persona + ", nom2_persona=" + nom2_persona + ", ape1_persona=" + ape1_persona + ", ape2_persona="
                + ape2_persona + ", fecha_nacimiento=" + fecha_nacimiento + ", edad_persona=" + edad_persona
                + ", direc_persona=" + direc_persona + ", tel_persona=" + tel_persona + ", email_persona="
                + email_persona + ", fk_genero=" + fk_genero + ", fk_eps=" + fk_eps + ", fk_rh=" + fk_rh + '}';
    }
